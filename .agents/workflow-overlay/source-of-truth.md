...
- Source hierarchy is not a read-all list. Use `.agents/workflow-overlay/source-loading.md` and `docs/workflows/forseti_repo_map_v0.md` to choose bounded source packs; use `docs/workflows/orca_repo_map_v0.md` only as the legacy detailed compatibility map.
...
- `docs/workflows/forseti_repo_map_v0.md`: compact Forseti repo map for source-pack selection and prompt setup; canonical cold-start route card.
- `docs/workflows/orca_repo_map_v0.md`: legacy detailed compatibility map for pre-Forseti physical roots and historical route detail; cold starts use `docs/workflows/forseti_repo_map_v0.md`.
...
- `docs/decisions/orca_product_thesis_consumer_demand_v0.md`: current Forseti product thesis and value proposition (legacy-named path, owner-ratified 2026-06-12; supersedes the earlier turn-08 thesis, retained as history).
