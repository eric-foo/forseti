...
direction_change_propagation:
  ...
  intentionally_not_updated:
    - path: forseti/product/spines/data_lake/authority/ (AR implementation, storage, physicality contracts) and the MGT baseline item 2
      reason: >
    ...
    - path: forseti/product/spines/data_lake/workflows/ (Gate 1 ADR, upgrade scoping, proof scoping route)
      reason: >
