...
direction_change_propagation:
  ...
  stale_language_search: >
    ...
    stays gated|A2 fork" forseti/product/spines/data_lake
...
direction_change_propagation:
  ...
  intentionally_not_updated:
    ...
    - path: forseti/product/spines/data_lake/workflows/core_spine_v0_data_lake_bronze_lake_owner_explainer_v0.md
      reason: >
