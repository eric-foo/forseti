...
direction_change_propagation:
  ...
  downstream_surfaces_checked:
    ...
    - forseti-harness/source_capture/ig_projection.py
    - forseti-harness/source_capture/retail_pdp_projection.py
  intentionally_not_updated:
    - path: forseti-harness/source_capture/models.py and writer/projection code
      reason: >
...
direction_change_propagation:
  ...
  intentionally_not_updated:
    ...
    - path: forseti/product/spines/capture/core/packet_schema/source_capture_tenant_payload_attachment_boundary_v0.md
      reason: >
