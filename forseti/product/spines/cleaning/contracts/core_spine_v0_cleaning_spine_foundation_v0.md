...
- Projection doctrine source at authoring: `PR_191` / worktree source. Local `main`
  did not contain `forseti/product/shared/projection_doctrine/core_spine_v0_projection_doctrine_v0.md` on intake.
- Implementation authorized: bounded_substrate_v0 (source-invariant Pydantic models + exact-identity deriver; `forseti-harness/cleaning/`; does not authorize broader Cleaning, ECR, or Judgment implementation)
...
orca_start_preflight:
  ...
  target_scope: forseti/product/spines/cleaning/contracts/core_spine_v0_cleaning_spine_foundation_v0.md
