...
stale_if:
  ...
  - forseti-harness/source_capture/models.py changes the SourceCapturePacket posture fields or PreservedFile shape.
...
- Sources: `jsg01_source_side_receipt_translator_v0.md` (untracked; SHA256 `E8944D13…92B2` = pin ✓), its adversarial review (untracked; AR-01/AR-03), `core_spine_v0_data_capture_spine_obligation_contract_v0.md` (Ob.8-15), `core_spine_v0_data_and_cleaning_spine_boundary_v0.md` (modified; Inclusion State Rule 158-176, reserved consolidation 281-309), `forseti-harness/source_capture/models.py`, `forseti-harness/source_capture/source_quality.py` (archive-dating mechanism), `forseti-harness/schemas/case_models.py` (`EvidenceUnit.hash_basis`).
