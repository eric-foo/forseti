...
(`pydantic_schema_reference.md`, `forseti-harness/schemas/case_models.py`, fixtures).
...
direction_change_propagation:
  ...
  downstream_surfaces_checked:
    ...
    - forseti-harness/schemas/case_models.py
    - docs/review-outputs/adversarial-artifact-reviews/jsg01_source_side_receipt_translator_adversarial_review_v0.md
  ...
  stale_language_search_result: >
    ...
    COLLIDES with forseti-harness/source_capture/models.py PacketTiming.cutoff_posture,
