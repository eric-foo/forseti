...
open_next:
  ...
  - forseti/product/spines/capture/core/contracts/obligation_contracts/data_capture_spine_posture_vocabulary_enforcement_proposal_v0.md
input_hashes:
...
| `forseti-harness/source_capture/models.py` | Read-only orientation on current implemented VisibleFact posture shapes | modified; not used as Forseti authority |
