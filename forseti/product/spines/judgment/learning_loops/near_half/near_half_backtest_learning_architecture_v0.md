...
open_next:
  - forseti/product/spines/judgment/learning_loops/near_half/near_half_signal_reliability_ledger_v0.md  # nonresolving: forward-reference; lands via PR #54 (step 1), pinned at promotion (see depends_on)
...
orca_start_preflight:
  ...
  target_scope:
    - forseti/product/spines/judgment/learning_loops/near_half/near_half_backtest_learning_architecture_v0.md (new, this file only)
...
direction_change_propagation:
  ...
  downstream_surfaces_checked:
    - forseti/product/spines/judgment/learning_loops/near_half/near_half_signal_reliability_ledger_v0.md  # consumed by pointer (signal sink); emit boundary matches its named backtest-postmortem inflow; no edit
    - forseti/product/spines/judgment/learning_loops/far_half/prospective_decision_loop_target_architecture_v0.md  # this fills the "near half owns lesson validation" slot it declared; the citation guard is the live-firewall analog of its disclosure-burns-comparator rule; no edit (it already routed validation here)
    ...
    - forseti/product/spines/judgment/conductor/conductor_construction_integrity_probe_addendum_v1.md  # derivability bar + quarantine-as-data + de-correlation reused, not amended
    - forseti/product/spines/judgment/claim_ladder/judgment_spine_evidence_ladder_architecture_v0.md  # product-learning cap consumed; no tier minted
  intentionally_not_updated:
    - path: forseti/product/spines/judgment/learning_loops/far_half/prospective_decision_loop_target_architecture_v0.md
    ...
    - path: forseti/product/spines/judgment/learning_loops/near_half/near_half_signal_reliability_ledger_v0.md
