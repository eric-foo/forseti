...
stale_if:
  - The Judgment spine corpus migrates from forseti/product/ into forseti/product/.
...
This is a legacy physical path under `forseti/product/`. Forseti is the project
