...
open_next:
  - forseti/product/spines/judgment/demand_read/c3_verdict_action/judgment_spine_c3_verdict_action_ceiling_contract_v0.md  # parent: the contestant-emit contract (transient-default / earned-durable; the ceiling vocabulary + cap rule the action axis grades against)
  - forseti/product/spines/foundation/demand_read_taxonomy/orca_demand_read_taxonomy_v0.md                            # parent: the Calling Sequence (transient-first -> monitor -> earn durable) this rule is entailed by
  ...
  - forseti-harness/cases/product_learning/topicals_retail_expansion_2021_v0/first_demand_read_findings_v0.md  # the worked example that surfaced this rule
stale_if:
...
skill is a **separate, deployment-gated question** outside Forseti authority (the
...
- `forseti-harness/cases/product_learning/topicals_retail_expansion_2021_v0/first_demand_read_findings_v0.md`
