...
open_next:
  - forseti/product/spines/judgment/demand_read/core/judgment_spine_demand_read_machinery_architecture_v0.md  # the C0–C4 core being run
  - forseti/product/spines/judgment/demand_read/c2_weighting/judgment_spine_c2_ledger_read_contract_v0.md             # C2 (Weight) contract
  - forseti/product/spines/judgment/demand_read/c3_verdict_action/judgment_spine_c3_verdict_action_ceiling_contract_v0.md  # C3 (Verdict + Ceiling) contract
...
5. **C3 Verdict + Ceiling.** Per the C3 contract: emit the two-axis verdict
   ...
   engagement/resonance-only caps; weakest load-bearing evidence binds). Public-
   reaction engagement may shape qualitative resonance weight and attention in
   the reasoning trace, but it does not become buyer proof, Commit-grade support,
   numeric weight, validation, readiness, or a claim-tier promotion by itself.
   Fill the sealed_call (recommendation, qualitative confidence_band,
   signals_used, required reasoning_trace).
