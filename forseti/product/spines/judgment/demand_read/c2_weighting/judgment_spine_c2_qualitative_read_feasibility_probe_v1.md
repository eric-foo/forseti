...
open_next:
  - forseti/product/spines/judgment/demand_read/c2_weighting/judgment_spine_c2_qualitative_read_feasibility_probe_v0.md  # the v0 probe + its graded-weak result (provenance)
  - forseti/product/spines/judgment/demand_read/c2_weighting/judgment_spine_c2_ledger_read_contract_v0.md                # the spec whose premise this tests
  - forseti/product/spines/judgment/learning_loops/near_half/near_half_signal_reliability_ledger_v0.md                   # the ledger schema the synthetic cases instantiate (#54)
stale_if:
