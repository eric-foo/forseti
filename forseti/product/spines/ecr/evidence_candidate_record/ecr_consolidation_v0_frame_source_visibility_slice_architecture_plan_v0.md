...
open_next:
  - forseti/product/spines/judgment/source_side_receipts/jsg01_sp6_source_visibility_derivation_architecture_plan_v0.md
  - forseti/product/spines/foundation/product_contract/core_spine_v0_data_and_cleaning_spine_boundary_v0.md
  - forseti/product/spines/judgment/source_side_receipts/jsg01_source_side_receipt_translator_v0.md
input_hashes:
...
stale_if:
  ...
  - forseti-harness/source_capture/models.py changes SourceCapturePacket (CapturePacket) posture fields, PreservedFile, or hash_basis.
...
| **`SourceCapturePacket`** (CapturePacket) (`forseti-harness/source_capture/models.py`) | **Producer** (sole source-side writer) | ECR binds to its real fields by reference/derive (D4); never writes into it. |
...
- **Read directly (lane):** the three pinned docs; `core_spine_v0_data_and_cleaning_spine_boundary_v0.md` (modified; reserved consolidation 281-309, Inclusion State Rule 158-176, ECR owns/must-not 74-75); `forseti-harness/source_capture/models.py` (modified; SourceCapturePacket/VisibleFact/PreservedFile/SourceCaptureSlice/PacketTiming + the verified hash_basis + closed vocabularies); `forseti-harness/source_capture/source_quality.py` (modified; archive-dating + `_source_time` decoupling); `forseti-harness/schemas/case_models.py` (`EvidenceUnit.hash_basis:61`).
