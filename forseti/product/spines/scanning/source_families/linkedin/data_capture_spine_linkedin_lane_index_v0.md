...
- **Slice 1 — candidate records:** `forseti-harness/capture_spine/linkedin_lane/`
  (`RunEnvelope` + `CandidateRow` + validators). Tests:
  `forseti-harness/tests/unit/test_linkedin_lane.py`.
- **Slice 2 — graph frontier:** `forseti-harness/capture_spine/linkedin_graph_frontier/`
  ...
  `forseti-harness/tests/unit/test_linkedin_graph_frontier.py`.
- Pattern siblings: `forseti-harness/capture_spine/reddit_candidate_intake/`,
  `forseti-harness/capture_spine/reddit_graph_frontier/`.
...
- **Bounded Watch / influence trajectory:** `forseti/product/spines/scanning/source_families/linkedin/data_capture_spine_linkedin_influence_trajectory_watch_spec_v0.md`.
- **Out-of-lane, legally-gated future lanes** (relationship-graph analytics;
  contact/outreach): `forseti/product/spines/capture/core/operating_model/data_capture_spine_future_exploration_lanes_v0.md`.
