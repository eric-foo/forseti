...
open_next:
  ...
  - forseti/product/spines/capture/core/demand_durability_indicators/price_timeseries/demand_durability_indicator_price_timeseries_capture_profile_v0.md  # Sibling indicator profile (pinning + cold-start shared doctrine)
stale_if:
