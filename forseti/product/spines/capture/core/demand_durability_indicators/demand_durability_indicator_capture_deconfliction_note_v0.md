...
open_next:
  - forseti/product/spines/capture/core/demand_durability_indicators/capture_envelope_durability_delta_spec_v0.md       # keystone delta (consumed by all four profiles)
  ...
  - forseti/product/spines/capture/core/demand_durability_indicators/review_velocity/demand_durability_indicator_review_velocity_corpus_capture_profile_v0.md
  - forseti/product/spines/capture/core/demand_durability_indicators/demand_durability_indicator_standing_capture_obligation_home_decision_framing_v0.md
stale_if:
...
(residential exit IPs, `ProxyProfile` in `forseti-harness/source_capture/proxy_profiles.py`);
...
direction_change_propagation:
  ...
  stale_language_search: >
    git grep -ilE "demand[ _-]proxy|durability proxy" -- docs/ forseti-harness/
