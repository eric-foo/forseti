...
open_next:
  ...
  - forseti/product/spines/capture/core/contracts/obligation_contracts/core_spine_v0_data_capture_spine_obligation_contract_v0.md  # Capture Envelope of record (obligations)
  ...
  - forseti-harness/source_capture/cadence.py                                             # CadencePlan planning primitive
stale_if:
  - The Source Capture packet schema (forseti-harness/source_capture/models.py) changes PacketTiming, the closed posture vocabularies, hash_basis, or re_capture_relationship in a way that overlaps these delta facts.
...
1. **The shipped Source Capture packet schema** —
   `forseti-harness/source_capture/models.py`. It already provides:
...
`forseti-harness/source_capture/cadence.py` already provides a **planning
