...
open_next:
  - forseti/product/spines/capture/core/demand_durability_indicators/capture_envelope_durability_delta_spec_v0.md   # Lane 1 envelope-delta (Element 1–5 consumed here)
  - forseti-harness/source_capture/models.py                                            # Capture Envelope of record (schema)
  ...
  - forseti-harness/source_capture/price_payload_extraction.py                          # Existing price extraction — cite-and-extend, do not re-spec
stale_if:
...
- Source basis: `capture_envelope_durability_delta_spec_v0.md` (Lane 1, PR #93),
  ...
  `forseti/product/spines/capture/core/contracts/obligation_contracts/core_spine_v0_data_capture_spine_obligation_contract_v0.md`,
  `forseti-harness/source_capture/price_payload_extraction.py`,
...
1. **Schema** — `forseti-harness/source_capture/models.py`:
...
`forseti-harness/source_capture/price_payload_extraction.py` is a
...
`forseti-harness/source_capture/price_payload_extraction.py` applies (SPA pricing
...
`CadencePlan` vocabulary (`forseti-harness/source_capture/cadence.py`), record
...
lifecycle:
  ...
  pr_base: main
  lane_1_consumed:
    spec: forseti/product/spines/capture/core/demand_durability_indicators/capture_envelope_durability_delta_spec_v0.md
    pr: "#93"
