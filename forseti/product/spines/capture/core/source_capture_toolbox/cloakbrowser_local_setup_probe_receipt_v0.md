...
- Probe location: `forseti-harness/_test_runs/cloakbrowser_api_probe/`
- Probe dependency target: `forseti-harness/_test_runs/cloakbrowser_api_probe/site`
- Git hygiene: `forseti-harness/_test_runs/` is ignored by `.gitignore`.
...
probe_site=C:\Users\vmon7\Desktop\projects\orca\forseti-harness\_test_runs\cloakbrowser_api_probe\site\cloakbrowser-0.3.31.dist-info
```
