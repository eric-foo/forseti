...
stale_if:
  - The CW-P1 scratch packet under forseti-harness/_test_runs/ is unavailable or changed.
...
Packet path:
`forseti-harness/_test_runs/source_quality_mixed_trial_20260603_153531/cw_p1_archive`.
...
```text
forseti-harness/_test_runs/source_quality_cw_p1_end_to_end_20260603/cw_p1_skeleton.yaml
```
...
mini_god_tier_source_quality_report:
  ...
  packet_path: forseti-harness/_test_runs/source_quality_mixed_trial_20260603_153531/cw_p1_archive
  best_in_bound_body:
    posture: metadata_only
    preserved_body_path: none
    sha256: none
