...
```powershell
python forseti-harness\runners\run_source_capture_packet.py `
...
`forseti-harness/runners/run_source_quality_report_skeleton.py` and reads packet
...
The helper is implemented in
`forseti-harness/runners/run_source_quality_state_assembler.py`.
...
`forseti-harness/source_capture/adapters/cloakbrowser_snapshot.py` with runner
`forseti-harness/runners/run_source_capture_cloakbrowser_packet.py`. Patchright
...
This helper already exists under `forseti-harness/source_observability/`.
...
9. Add Reddit API adapter and credential support. **Authorized by second tranche;
   implementation status should be checked in `forseti-harness/source_capture/`
   before use.**
...
direction_change_propagation:
  ...
  controlling_sources_updated:
    ...
    - "forseti-harness/tests/contract/test_source_capture_cloakbrowser_snapshot_contract.py"
    - "forseti-harness/tests/contract/test_source_capture_browser_snapshot_contract.py"
  ...
  stale_language_search: "rg -n \"CloakBrowser.*not implemented|not implemented.*CloakBrowser|future primary backend|STEP-01 adapter contract|once implemented|not an implemented runner|live CloakBrowser engine, packet runner\" forseti/product/spines/capture/core/source_capture_toolbox/README.md forseti-harness/docs/source_capture_agent_runbook.md forseti-harness/README.md docs/workflows/orca_repo_map_v0.md docs/workflows/data_capture_spine_consolidation_map_v0.md forseti-harness/source_capture forseti-harness/runners forseti-harness/tests"
...
direction_change_propagation:
  ...
  downstream_surfaces_checked:
    ...
    - ".agents/workflow-overlay/artifact-folders.md"
    - "forseti-harness/README.md"
    - "forseti-harness/docs/source_observability_scalability_note.md"
  intentionally_not_updated:
    - path: "docs/product/data_capture_source_access_boundary_decision_v0.md"
    ...
    - path: "forseti-harness/docs/source_observability_scalability_note.md"
...
direction_change_propagation:
  ...
  controlling_sources_updated:
    ...
    - "docs/decisions/source_capture_packet_fixture_retention_sensitivity_decision_v0.md"
    - "forseti-harness/docs/source_capture_agent_runbook.md"
    - "forseti-harness/docs/source_capture_packet.md"
    - "forseti-harness/README.md"
  downstream_surfaces_checked:
    - "AGENTS.md"
    - "CLAUDE.md"
...
direction_change_propagation:
  ...
  stale_language_search: "rg -n \"archive fallback|same-thread canonical|snapshot_count=0|network security|ambient proxy|Do not chain runners|archive_body_not_preserved\" forseti/product/spines/capture/core/source_capture_toolbox/README.md forseti-harness/docs/source_capture_agent_runbook.md forseti/product/spines/capture/core/source_capture_toolbox/reddit_precommercial_capture_consolidation_planning_thread_v0.md docs/workflows/data_capture_spine_consolidation_map_v0.md .agents/workflow-overlay/source-loading.md"
