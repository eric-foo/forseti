...
- `forseti-harness/source_capture/adapters/reddit_api.py`
- relevant existing runners under `forseti-harness/runners/`
- relevant tests under `forseti-harness/tests/`

External public orientation checked after the initial artifact was written:

- `https://github.com/CloakHQ/cloakbrowser`

This external check is not Forseti authority, validation, install proof, or legal
...
5. Add no-secret, disclosability-inverse, proxy-boundary-if-scoped,
   ...
   runbook exposure.
6. Patch `forseti-harness/docs/source_capture_agent_runbook.md` with exact command,
