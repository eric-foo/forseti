...
stale_if:
  - The CW-P4 scratch packet under forseti-harness/_test_runs/ is unavailable or changed.
...
Packet path:
`forseti-harness/_test_runs/source_quality_cw_p4_20260603_052930/archive_cw_p4`.
...
```text
forseti-harness/_test_runs/source_quality_cw_p4_end_to_end_20260603/cw_p4_skeleton.yaml
```
...
mini_god_tier_source_quality_report:
  ...
  packet_path: forseti-harness/_test_runs/source_quality_cw_p4_20260603_052930/archive_cw_p4
  best_in_bound_body:
    posture: preserved
    preserved_body_path: raw/02_archive_snapshot_body.bin
    sha256: 1E4CFC078AFC878E9430EF1E7BE20C7587AFDB857AB7EAEFAE7ACCA7C5D17C7C
