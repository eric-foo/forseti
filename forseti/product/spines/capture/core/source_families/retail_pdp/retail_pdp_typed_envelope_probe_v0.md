...
direction_change_propagation:
  ...
  downstream_surfaces_checked:
    ...
    - forseti-harness/runners/run_retail_pdp_projection.py
  ...
  intentionally_not_updated:
    - path: forseti-harness/source_capture/retail_pdp_projection.py
  ...
  stale_language_search: >
    ...
    docs/product docs/workflows forseti-harness/source_capture forseti-harness/runners forseti-harness/tests
  non_claims:
    - not validation
    - not readiness
