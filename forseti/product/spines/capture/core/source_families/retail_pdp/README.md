...
| --- | --- | --- |
| Access / method | `retailer_information_extraction_standard_v0.md`, `retail_pdp_projection_contract_v0.md`, `retail_pdp_projection_playbook_v0.md`, `retail_pdp_sidecar_operator_playbook_v0.md` | Cross-retailer evidence categories and discovery behavior; retailer-specific capture inputs, residual vocabulary, target DOM price/SKU binding posture, and the no-ECR/Cleaning/Judgment boundary. |
