...
open_next:
  - forseti/product/spines/capture/core/source_capture_toolbox/README.md                                   # the Armory (rendered adapters)
  - forseti/product/spines/capture/core/source_capture_toolbox/capture_recon_index_v0.md                   # Sephora/Ulta recon (worktree, pending-merge); no Amazon recon
  - forseti/product/spines/capture/core/source_capture_toolbox/source_capture_playbook_v0.md               # the capture PLAYBOOK (probe-then-pin, recon procedure) — USE IT to assess each retailer
  - forseti/product/spines/capture/core/source_capture_toolbox/source_capture_anti_block_ladder_usage_guide_v0.md   # anti-block ladder (direct_http -> anti_blocking_http -> visible browser -> cloakbrowser+proxy)
  - forseti/product/spines/capture/core/source_capture_toolbox/cloakbrowser_packet_runner_architecture_v0.md
  - forseti/product/spines/capture/core/contracts/source_access_boundary/data_capture_source_access_boundary_decision_v0.md
  - forseti/product/spines/capture/core/contracts/obligation_contracts/core_spine_v0_data_capture_spine_obligation_contract_v0.md   # Ob.6 fidelity, Ob.17 durability facts
  - forseti-harness/runners/run_source_capture_durability_series.py                    # the step-3 cadence runner (the consumer)
stale_if:
