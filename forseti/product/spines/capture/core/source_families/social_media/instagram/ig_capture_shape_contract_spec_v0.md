...
open_next:
  ...
  - forseti-harness/source_capture/models.py                                                       # the packet model (gated build target; NOT edited by this spec)
...
`49b5d0b`); `forseti-harness/source_capture/models.py` + the IG capture findings (ig-cadence-rails worktree
