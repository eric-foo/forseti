...
| Daily heartbeat policy | `ig_daily_heartbeat_operating_policy_v0.md` | Current owner direction for steady daily registered-creator grid heartbeat; excludes onboarding and does not claim runner implementation alignment. |
