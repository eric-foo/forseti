...
- DOM probe, `768x1024`: `forseti-harness/_test_runs/ig_vanzz_reels_dom_probe_768x1024_20260622_1/`.
- DOM probe, `1080x1920`: `forseti-harness/_test_runs/ig_vanzz_reels_dom_probe_1080x1920_20260622_1/`.
- High-viewport failure: `forseti-harness/_test_runs/ig_vanzz_reels_dom_probe_5204x4728_20260622_1/`.
- Passive network sniff: `forseti-harness/_test_runs/ig_vanzz_reels_network_sniff_20260622_1/`.
- `/clips/user` metadata probe: `forseti-harness/_test_runs/ig_vanzz_reels_json_ad_metadata_20260622_1/summary.json`.
- CloakBrowser viewport/source-surface probe: `forseti-harness/_test_runs/ig_cloakbrowser_jeremyfragrance_reels_20260622_1/summary.json` and `1920x4000/joined_rows.json`.
- Zoom matrix diagnostic: `forseti-harness/_test_runs/ig_jeremyfragrance_reels_zoom_matrix_20260622_1/summary.json`.
- Existing caption parser: `forseti-harness/source_capture/ig_momentum_harvest.py` parses
...
spec_handoff:
  ...
  current_path: forseti/product/spines/capture/core/source_families/social_media/instagram/ig_profile_grid_dom_engagement_recon_and_spec_v0.md
  required_behavior:
