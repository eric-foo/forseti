...
use_when:
  ...
  - Finding the legacy foundation product-contract owners that still live under forseti/product/.
...
stale_if:
  - The legacy foundation corpus migrates from forseti/product/ into forseti/product/.
...
under `forseti/product/` until a separate migration moves them.
