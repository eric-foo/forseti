...
| 14 | **CapturePacket** | A write-once, hash-pinned source-capture packet — the raw provenance an Observation derives from. | manifest_version, cutoff_posture | `forseti-harness/source_capture/models.py` |
...
| Judgment-run gates JSG-01..JSG-10 | `forseti/product/spines/judgment/conductor/judgment_spine_gate_ownership_map_v0.md` |
