...
naming_authority: forseti/product/spines/foundation/ontology/orca_ontology_backbone_architecture_v0.md  # §2.2 (type Outcome) + §2.1 (ID grammar)
```
...
- **backing artifacts** (pointers — NOT restated):
  - known-outcome / calibration target → `forseti-harness/cases/product_learning/beautypie_repricing_2023_v0/facilitator_ledger.yaml`
