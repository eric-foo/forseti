...
| Forecast record and eval | Current-state/decomposition forecast boundary plus near-half product-learning evaluation surface | Store raw probabilities, probability buckets, horizons, due dates, and later outcome labels (Outcome) as learning material | JSG-08 calibration, buyer proof, or judgment-quality evidence |
...
verified_assumptions:
  - assumption: The temp pack is draft input, not current Forseti authority.
