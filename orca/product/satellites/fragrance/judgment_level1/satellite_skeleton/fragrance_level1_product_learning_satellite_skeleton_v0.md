...
open_next:
  ...
  - orca/product/satellites/fragrance/judgment_level1/casebook_admission/fragrance_level1_casebook_admission_frame_v0.md
  - orca/product/satellites/fragrance/judgment_level1/named_case_screens/fragrance_level1_named_case_candidate_screen_v0.md
...
| Casebook queue | Candidate cases (Case), cutoff dates, outcome labels (Outcome), exclusion reasons | Current-state/decomposition map; C0 frame, case-finder gap, conductor run authorization boundary | Separate casebook admission artifact | Accepted benchmark, fixture, run authorization, readiness, or scoreable case |
