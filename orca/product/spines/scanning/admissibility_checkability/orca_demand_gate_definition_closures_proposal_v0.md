...
applies_to:
  - orca/product/spines/product_lead/buyer_proof/orca_buyer_proof_packet_v0.md            # Demand-Substrate Hard Gate G1 + G2 (APPLIED 2026-06-14)
  - orca/product/spines/product_lead/icp_wedge/orca_discovery_consumer_demand_target_selection_brief_v0.md  # qualification objective #3 + slot column (APPLIED 2026-06-14)
ripple_surfaces:
  - orca/product/spines/foundation/demand_read_taxonomy/orca_demand_read_taxonomy_v0.md          # retail = org-motion (already states it; cite, confirm before claiming)
