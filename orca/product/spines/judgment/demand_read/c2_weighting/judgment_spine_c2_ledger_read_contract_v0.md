...
open_next:
  - orca/product/spines/judgment/learning_loops/near_half/near_half_signal_reliability_ledger_v0.md             # the ledger this consumes (producer-side schema + discipline; #54)
  - orca/product/spines/judgment/demand_read/core/judgment_spine_demand_read_machinery_architecture_v0.md # the demand-read core whose C2(c) this specifies (commit e794b8f, branch-only)
stale_if:
...
spec_handoff:
  ...
  review_timing_advisory:
    ...
    review_target: orca/product/spines/judgment/demand_read/c2_weighting/judgment_spine_c2_ledger_read_contract_v0.md
    why_this_checkpoint: >
...
direction_change_propagation:
  ...
  downstream_surfaces_checked:
    - orca/product/spines/foundation/demand_read_taxonomy/orca_demand_read_taxonomy_v0.md   # already two-axis + Calling Sequence (C3 transient handling); "hollow" hits are the retirement explanation, kept
