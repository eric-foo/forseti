...
def _fixture_dom(*, ai_summary: bool = False) -> bytes:
    product = {
...
def test_nordstrom_v4_retains_target_product_state_variants_reviews_and_loss() -> None:
...
def test_nordstrom_v4_fails_closed_when_new_ai_sentiment_appears() -> None:
...
def test_nordstrom_v4_content_qualification_matches_and_releases_scratch(
    tmp_path: Path,
) -> None:
