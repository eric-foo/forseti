...
NORDSTROM_PDP_PARSER_VERSION = "retail_pdp_nordstrom_aggregate_parser_v4"
...
class NordstromPdpAggregateContentRecord(StrictModel):
    ...
    def validate_counts(self) -> "NordstromPdpAggregateContentRecord":
        ...
        if (
            self.parser_version == "retail_pdp_nordstrom_aggregate_parser_v4"
    ...
    *,
    ...
    entries = [
        ...
        NordstromPdpContentLossEntry(
            ...
            count=5,
            reason=(
                "recommendation, unhelpful count, reviewed variant, demographic "
                "declarations, and tag fields are not exposed in the rendered review cards"
            ),
            source_anchor_kind="file",
        ),
        NordstromPdpContentLossEntry(
    ...
    return (
        {
            ...
            "review_field_exposure": {
                ...
                "variant": "not_exposed_in_rendered_review_cards",
                "review_media": (
