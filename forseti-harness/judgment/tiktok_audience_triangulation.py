...
def build_triangulation_prompt(bundle: Mapping[str, Any]) -> str:
    return (
        ...
        "multi_video and mixed_multi_video require all_support_evidence_ids spanning at least two "
        "source videos; counterevidence does not count toward support scope. "
        "For relation missing, set representative_evidence_ids, all_support_evidence_ids, and "
        "counterevidence_ids to empty arrays; the derived source_video_ids will also be empty. "
        "Every other relation requires 1-5 representative evidence IDs and at least one full-support "
        "evidence ID. "
