...
implemented in `forseti-harness`. It packages already-local source artifacts into a
...
`forseti-harness/_auth_state/`. It writes no packet. It does not accept username,
