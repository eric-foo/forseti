...
| `.github/scripts/merge-when-green.ps1` | Update the default required check name; leave `Repo = 'eric-foo/orca'` until the owner-gated external repo rename succeeds. |
