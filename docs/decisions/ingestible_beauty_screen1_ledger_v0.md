...
open_next:
  - forseti/product/spines/foundation/vertical_exploration/orca_vertical_exploration_guide_v0.md      # the guide this run proved
  - forseti/product/satellites/beauty/beauty_venue_card_set_v0.md                # adjacent vertical's promoted deck (shared hub observed)
