...
open_next:
  - docs/product/foundation/orca_vertical_exploration_guide_v0.md      # the guide this run proved
  - docs/product/foundation/beauty_venue_card_set_v0.md                # adjacent vertical's promoted deck (shared hub observed)
