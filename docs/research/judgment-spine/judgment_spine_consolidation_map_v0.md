...
| Instruct a model to weight presented evidence — assign decision-relative qualitative evidence weights, or judge how much a source counts for this decision (merits half; the reliability-prior half is its sibling ledger read contract) | `forseti/product/spines/judgment/demand_read/c2_weighting/judgment_spine_c2_in_case_evidence_weighting_doctrine_v0.md` | product |
