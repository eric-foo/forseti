...
handoff. Live-route note: the prior handoff and recipe-v0 paths from the
source branch are not current live route targets; use the recipe-v1
record for the current D-1 route.
