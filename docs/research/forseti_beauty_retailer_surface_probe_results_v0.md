...
At the time of this audit, the exact Sephora and Nordstrom aggregate-PDP routes
proved sampled-raw with full-derived retention through the receipts below. The
remaining surface-mode inventory is likewise frozen to that audit; it is not a
statement of later route promotions. Every other retailer surface named here
was raw: Target grid
...
### Historical Nordstrom sampled-raw/full-derived audit receipt (superseded for new acquisition)
