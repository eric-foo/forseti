...
- `docs/research/diagnosis_batched_coordination_20260909/report.md`: commissioned sample-local before/after experiment, frozen fixtures, reader logs and adapter scripts. Lower measured cost with unresolved diagnostic quality failures; no production-method adoption.
