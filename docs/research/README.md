...
- `docs/research/packaging_diagnosis_sample_20260909/report.md`: bounded engagement-first packaging diagnosis worked replay; exploratory only, with no token-savings or production-completion claim.
