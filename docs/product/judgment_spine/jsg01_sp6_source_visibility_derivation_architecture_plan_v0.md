...
| `:309` "Final ECR/Evidence Unit field architecture" | **Begins it** | Declaring an ECR field is the first authored increment — the single most owner-reserved line. |
