...
| `docs/product/source_capture_toolbox/source_quality_mini_god_tier_profile_v0.md` | `048CC8065CC57683C8A783B471E19D60DBB7F4768DDFE81ABFCAE604CCBAEA09` | Result-token and lifecycle vocabulary for this closeout. |
| `docs/product/source_capture_toolbox/source_quality_state_assembler_v0.md` | `39CB2E59F1827CAE9B5CF0806D3236222DAC5800FB128254B1AD54479F97694E` | State-census boundary that keeps helper suggestions separate from operator-reported rows. |
