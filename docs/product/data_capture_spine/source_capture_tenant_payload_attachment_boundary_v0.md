...
- `docs/product/data_capture_spine/orca_capture_projection_storage_spine_architecture_v0.md`:
  ...
  language.
- `docs/product/core_spine_v0_projection_doctrine_v0.md`: Mechanical Source
...
direction_change_propagation:
  ...
  intentionally_not_updated:
    ...
    - path: docs/product/data_capture_spine/source_capture_packet_schema_evolution_architecture_v0.md
      reason: >
