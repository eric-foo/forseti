...
naming_authority: docs/product/core_spine/orca_ontology_backbone_architecture_v0.md  # §2.2 (type Case) + §2.1 (ID grammar, forward-only convention)
```
...
- **mapped owners** (this card POINTS; it does not restate):
  ...
  - claim_tier (receipt-gated outcome, never type-minted) → `docs/product/judgment_spine/judgment_spine_evidence_ladder_architecture_v0.md`
