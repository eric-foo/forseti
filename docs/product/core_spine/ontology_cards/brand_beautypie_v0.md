...
naming_authority: docs/product/core_spine/orca_ontology_backbone_architecture_v0.md  # §2.2 (type Brand) + §2.1 (ID grammar)
```
...
- **backing artifact** (pointer — NOT restated): `docs/product/core_spine/consumer_demand_candidate_pool_handoff_v0.md`
