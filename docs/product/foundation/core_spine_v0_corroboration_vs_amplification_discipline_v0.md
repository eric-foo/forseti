# Foundation Layer v0 — Corroboration vs Amplification Discipline (Cleaning ↔ Judgment)
...
boundary note's Layer Rules and Inclusion State Rule, and the Foundation Layer contract's
