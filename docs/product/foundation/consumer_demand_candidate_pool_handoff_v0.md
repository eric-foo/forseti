...
open_next:
  - docs/product/foundation/orca_memorization_resistant_case_finder_frame_v0.md   # operative obscurity bar + probe protocol
  - docs/decisions/judgment_spine_backtest_batch1_ledger_declaration_v0.md        # recognition/swap/split machinery exemplar
  - docs/product/judgment_spine/judgment_spine_evidence_ladder_architecture_v0.md # claim caps for any consumer
stale_if:
