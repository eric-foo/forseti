# Foundation Layer v0 Information Production Foundation

- Status: PROPOSED_FREEZE
- Artifact type: Product-method foundation
- Scope: Manual information-production rules for Foundation Layer v0
...
It is the product-method layer between Foundation Layer v0's contract and the proof
...
Use this manual chain for every Foundation Layer v0 information product:
