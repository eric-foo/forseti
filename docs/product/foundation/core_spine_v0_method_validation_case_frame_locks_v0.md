# Foundation Layer v0 Method Validation Case-Frame Locks
...
- Scope: Safe pre-replay frame locks for the five locked Foundation Layer v0 method-validation cases
- Date context: 2026-05-21, Asia/Singapore
- Source basis: current prompt, Orca overlay, `docs/decisions/turn_08_product_thesis_v0.md`, Foundation Layer v0 product and proof artifacts, the method-validation rubric, the case identity lock, and the case-frame lock contract
