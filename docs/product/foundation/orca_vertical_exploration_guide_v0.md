...
open_next:
  ...
  - docs/product/foundation/beauty_venue_card_set_v0.md                      # promoted beauty card-set (Step 0 reads it FIRST for beauty screens)
stale_if:
...
- 2026-06-11 (owner-accepted, in-thread; promote-on-reuse EXECUTED for
  ...
  `docs/product/foundation/beauty_venue_card_set_v0.md` (binding terms:
