# Foundation Layer v0 Cleaning Spine Foundation
...
orca_start_preflight:
  ...
  target_scope: docs/product/foundation/core_spine_v0_cleaning_spine_foundation_v0.md
...
direction_change_propagation:
  ...
  intentionally_not_updated:
    - path: docs/workflows/orca_repo_map_v0.md
      reason: >
        The artifact was created under an already map-covered Foundation Layer folder.
        The repo-map freshness checker remains required, but this additive draft
        does not reorganize the Foundation Layer section or require a new route before
        owner ratification.
    - path: docs/product/foundation/core_spine_v0_data_and_cleaning_spine_boundary_v0.md
      reason: >
