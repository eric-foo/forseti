...
naming_authority: docs/product/foundation/orca_ontology_backbone_architecture_v0.md  # §2.2 (type DecisionEvent) + §2.1 (ID grammar)
```
...
- **backing artifact** (pointer — NOT restated): `docs/product/foundation/consumer_demand_candidate_pool_handoff_v0.md`
