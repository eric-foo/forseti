# Foundation Layer v0 Heavyweight Proof Case Discovery Charter
...
The first Foundation Layer v0 proof-run charter has been accepted in chat and
...
- would this case test Foundation Layer without obvious cherry-pick risk.
...
- what recommendation Foundation Layer would make;
...
not use Foundation Layer action recommendation verbs or recommend any product,
...
- the case would require new Foundation Layer primitives.
...
proposal is only for case selection. It is not a Foundation Layer recommendation,
