...
branch_or_commit: post-R6-AR-01 de-leak (PR #37); baseline blob c0566790c890
input_hashes:
  participant_packet_baseline.md: c0566790c890d238d87338a814c3f635de0b75da
stale_if:
...
> **Re-pinned 2026-06-13 (landing pass).** Baseline updated to the post-R6-AR-01
> de-leak blob `c0566790c890d238d87338a814c3f635de0b75da` (PR #37); the embedded
> `capability_constraints` and `permitted_assumptions` brief lines below are updated
> to the de-leaked text so this courier does not re-ship the removed market-response/
> reaction vocabulary. The `option_value` assessment is unaffected by the de-leak. The
> original author's preflight below reflects the pre-de-leak authoring state.
...
option_value_second_label:
  ...
  labeled_from: participant_packet_baseline.md (blob c0566790, post-de-leak PR #37)
  outcome_blind: yes
...
> Exact file at blob `c0566790c890d238d87338a814c3f635de0b75da` (post-R6-AR-01 de-leak, PR #37). This is the core decision evidence. (The augmented arm adds an experimental hiring-intent signal that is not a band input and is intentionally not shown here.)
