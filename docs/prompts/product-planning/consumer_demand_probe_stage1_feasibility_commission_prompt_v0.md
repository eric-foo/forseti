...
open_next:
  ...
  - forseti/product/case_families/product_learning/fragrance/consumer_demand_candidate_pool_handoff_v0.md   # candidate input (facilitator-side; outcome-bearing)
input_hashes:
