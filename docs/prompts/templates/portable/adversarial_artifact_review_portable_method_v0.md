...
derived_from:
  - docs/prompts/templates/review/adversarial_artifact_review_v0.md@268f03fc3018328bbdb486a5f5e52f2f6ff2552b0d916d4a3bec91761e17f6c8   # re-derived 2026-07-16 (third pass, post-#1004 preflight smallest-complete reduction): the source template went pointer-first -- preflight_defaults + Template kind lines added; authority-source list, source-read budget, review-authority paragraph, and output-mode contract compressed to their overlay owners. Non-material to the PORTABLE METHOD body, which is deliberately self-contained: it ships with pasted authority excerpts instead of repo pointers, and sections 1/2/3/5/6 already inline the same semantics those compressed blocks now cite. (Prior pin b6ab8b23…e40d6c, earlier 2026-07-16: deep-thinking single-owner framing; before that afc441cf…c2ba9f, 2026-07-04.)
