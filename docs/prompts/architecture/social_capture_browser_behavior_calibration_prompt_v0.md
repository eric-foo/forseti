...
stale_if:
  - Capture core placement or social_media source-family structure changes.
...
template_kind: full-prompt; architecture/calibration commission; no runtime-model routing implication.
edit_permission: docs-write for one recommendation artifact only; no runtime edits.
prompt_artifact_path: docs/prompts/architecture/social_capture_browser_behavior_calibration_prompt_v0.md
...
review_contract: none; this is a recommendation artifact, not a formal review verdict.
...
branch_or_commit_reference: >
  Prompt port worktree codex/social-capture-browser-calibration-core-port from
  origin/main @ 2988c82f; source prompt reference
  codex/social-capture-browser-calibration-prompt @ 3b4fa17e, SHA256
  7E6F4672AF83FB6893C48980B4A82C0D43E95810B81A897EFB55A9C9D1B22390.
...
isolation_decision: worktree off current main; this is cross-lane docs work on a dirty-base repo.
