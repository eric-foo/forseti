...
- Playbook path: `docs/workflows/commission_signal_board_playbook_v0.md`.
- Prompt path: `docs/prompts/product-planning/orca_commission_signal_board_prompt_v0.md`.
