...
| Check logical data-lake mechanics from capture through projection, ECR/SCR, Cleaning, and Judgment | `docs/product/foundation/core_spine_v0_data_lake_mechanics_map_v0.md` |
...
- owner: `docs/product/foundation/core_spine_v0_data_lake_mechanics_map_v0.md`
...
- owner: `docs/product/source_capture_toolbox/reddit_precommercial_capture_consolidation_success_signal_architecture_v0.md`
...
- owners: `docs/product/source_capture_toolbox/ig_capture_findings_consolidated_v0.md`,
