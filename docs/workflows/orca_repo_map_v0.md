...
| `docs/research/` | Research artifacts and consulting-judgment corpus material, including answer-engine probe evidence under `docs/research/answer_engine/` and fragrance-native database route probes under `docs/research/orca_fragrance_native_database_live_probe_v0.md`. |
...
| `orca-harness/tests/` | `unit/`, `contract/`, and `integration/` tests plus fixtures, including no-LLM-import, no-tools contract guards, Fragrantica projection/Cleaning/lake tests, Commission Signal Board validator fixtures, and CSB-first scanning artifact checker fixtures. |
...
| `docs/research/orca_fragrance_native_database_live_probe_v0.md` | Fragrance-native database route probe and live capture-path pins for Fragrantica, Parfumo, and Basenotes. Use for CSB/Scanning-to-Capture source-family classification, Data Lake `fragrance_native_database` routing, Fragrantica/Parfumo direct-route residuals, and Basenotes authorized Chrome/profile selected-URL packet planning. Not a full-database crawler, anonymous Basenotes route, ECR, Cleaning, Judgment, or readiness claim. |
