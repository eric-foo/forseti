...
| `docs/decisions/orca_icp_wedge_consumer_demand_first_v0.md` | Current first-proof ICP wedge (beauty operator door; owner co-ratified 2026-06-12; supersedes pricing-first), decision-family focus, and active beauty sequence: fragrance allocation first, skincare medium-term, hair/scalp comparator/fallback. |
...
| `docs/product/source_capture_toolbox/ig_creator_roster_frontier_ledger_spec_v0.md` | Proposed IG beauty creator roster/frontier ledger contract for the fragrance-first 250-record gate and `250 -> 500 -> 1,000` path. Non-authorizing: no capture run, crawler, scheduler, runtime, outreach list, ontology change, validation, or readiness claim. |
