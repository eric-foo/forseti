...
| `orca/product/spines/scanning/` | Scanning (discovery-side) spine: scan_core, admissibility/checkability, source_families (answer_engine, linkedin, reddit). For the MGT intelligent-walk bridge, open `orca/product/spines/scanning/scan_core/orca_scanning_intelligent_walk_mgt_operating_model_v0.md`. |
