...
| `docs/workflows/ig_youtube_behavioral_e2e_closeout_receipt_v0.md` | Evidence-first IG/YT behavioral closeout receipt: current canonical F-lake IG projection status matrix, current YouTube projection-test evidence, and explicit blocker that canonical YT F-lake e2e is not observed because no YouTube packets are present in F:/orca-data-lake. |
