...
| `docs/research/aphrodite_depth_rehearsal_round2_gentsscents_grade_v0.md` | Round-2 depth rehearsal on GentsScents (YouTube long-form): measured substrate delta vs the Jeremy corpus and a re-grade (fit D+→B, ad-reception C-→C+) proving the round-1 caps were substrate-bound, not method-bound. |
