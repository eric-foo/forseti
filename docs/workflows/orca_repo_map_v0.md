...
| `docs/workflows/youtube_shorts_creator_index_decision_path_v0.md` | Source-backed workflow recommendation for splitting the 200-row YouTube Shorts fragrance creator evidence ledger from a future cross-lane creator index, including placement comparison, field contract, lifecycle boundary, and non-claims. |
