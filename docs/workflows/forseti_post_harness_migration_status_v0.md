...
Baseline census observed from `origin/main` after PR #675 merged as `c10f1d7f` on 2026-07-05. Later rows below record subsequent executed migration lanes where explicitly cited. Current convergence planning treats `origin/main` after PR #763 (`f0ce5b14`, including #753, #755, #756, #757, #758, #759, #760, and #763) as the baseline; pre-#753/#755/#756 migration branches are spent unless their remaining value is manually re-derived against current `main`.
...
| Current-main convergence | Executed through PR #763: #753 recorded the local checkout split, #755 landed ontology GT ladder/A1/A2/R0 SSOT fixes, #756 landed the TikTok packet-grade runner posture on `forseti-harness/`, #757 aligned the migration plan to current `main`, #758 migrated the ontology filename family, #759 migrated the product-lead authority filename family, #760 added the missing-work PR fanout handoff prompt, and #763 migrated the demand-read taxonomy filename family. | Future migration and conflict-resolution lanes start from current `main`; do not replay stale side-branch trees over #755/#756/#758/#759/#760/#763 files. |
...
Migration branches or handoffs authored before PR #753, PR #755, PR #756, PR #758, PR #759, PR #760, or PR #763 are
...
authority filenames, demand-read taxonomy files, vertical-exploration files, and TikTok runner/harness files
...
migration, #760 missing-work PR fanout prompt, and #763 demand-read taxonomy filename migration have landed, the remaining
material lanes are:
...
3. Continue family-by-family live filename migration for current product sources
   ...
   product-lead authority, and demand-read taxonomy filename families have
   landed, this lane handles the vertical-exploration filename family, and
   remaining families still need moved-path coverage plus a fresh read of any
   #755/#756/#758/#759/#760/#763-touched source before editing.
