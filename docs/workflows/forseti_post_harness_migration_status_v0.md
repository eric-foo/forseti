...
| Product-lead wrapper retirement readiness | Checked 2026-07-08 on current `origin/main` (`fd5742ea`): NOT READY. This lane re-synced `.claude/skills/forseti-product-lead/SKILL.md` to the `.agents` source (`332CF034B92DF701DA573FE3C92004F838B47E1C1759C1986AA4E2D944280634`); both `orca-product-lead` wrapper copies already matched (`3A7C819477F475761831B05E0A607CC3A8E1A0E97DCD6875438A79BB2706C3E0`). | Do not delete `.agents/skills/orca-product-lead/` or `.claude/skills/orca-product-lead/` until a fresh runtime proves `/forseti-product-lead` resolver-visible and legacy invocation consumers are classified. |
...
5. Retire compatibility wrappers such as `/orca-product-lead` only after one
   transition window and resolver behavior are verified. 2026-07-08 check:
   not ready; wrapper deletion remains blocked until `/forseti-product-lead`
   is resolver-visible in a fresh runtime and legacy invocation consumers are classified.
