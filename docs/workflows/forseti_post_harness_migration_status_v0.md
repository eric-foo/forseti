...
Baseline census observed from `origin/main` after PR #675 merged as `c10f1d7f` on 2026-07-05. Later rows below record subsequent executed migration lanes where explicitly cited. Current convergence planning treats `origin/main` after PR #780 (`2a684620`, including #753, #755, #756, #757, #758, #759, #760, #763, #765, #767, #768, #769, #770, #771, #772, #773, #774, #775, #776, #778, #779, and #780) as the baseline; pre-#753/#755/#756 migration branches are spent unless their remaining value is manually re-derived against current `main`.
...
| Product-lead ICP/wedge filename family | Executed by this bounded Product-lead ICP/wedge filename migration lane: the live product-lead ICP/wedge artifacts under `forseti/product/spines/product_lead/icp_wedge/orca_*_v0.md` now use Forseti filenames. | Historical old filenames resolve through `docs/migration/forseti_product_lead_icp_wedge_filename_migration_v0/moved_paths_index.md`; prompts, wrappers, and other lowercase `orca_*` filenames remain separate compatibility batches. |
...
Migration branches or handoffs authored before PR #753, PR #755, PR #756, PR #758, PR #759, PR #760, PR #763, PR #765, PR #767, PR #768, PR #769, PR #770, PR #771, PR #772, PR #773, PR #774, PR #775, PR #776, PR #778, PR #779, or PR #780 are
...
3. Continue family-by-family live filename migration for current product sources
   ...
   Tier doctrine, Doctrine Index, Repo-Map Architecture MGT, Repo Structure Binding, Spine-first structure, Product/spine binding, Audience taxonomy/prior, Data Lake derived-retrieval, and Product-strategy decision filename families have landed, this lane
   handles the Product-lead ICP/wedge filename family,
   and remaining families still need moved-path coverage plus a fresh read of any
   #755/#756/#758/#759/#760/#763/#765/#767/#768/#769/#770/#771/#772/#773/#774/#775/#776/#778/#779/#780-touched source before editing.
