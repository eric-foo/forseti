...
| `forseti/product/spines/product_lead/` | Product-Lead spine: offer, buyer_proof, proof_charter, icp_wedge, growth (engine-as-product monetization exploration, EXPLORATORY / owner-gated). |
