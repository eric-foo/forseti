...
| Check logical data-lake mechanics across capture, projection, ECR/SCR, Cleaning, and Judgment | `docs/product/foundation/core_spine_v0_data_lake_mechanics_map_v0.md` |
...
- **Cross-layer mechanics map:** `docs/product/foundation/core_spine_v0_data_lake_mechanics_map_v0.md`
